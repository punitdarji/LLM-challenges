...
```
git clone https://github.com/punitdarji/LLM-challenges
```
Move to folder
```
cd LLM-challenges
...
```
python challengename.py
```

### Follow me

- [Linkedin](https://www.linkedin.com/in/punitdarji/)

- [YouTube](https://www.youtube.com/@punitdarji1871)
